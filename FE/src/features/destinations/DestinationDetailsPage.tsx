...
export default function DestinationDetailsPage({
  ...
  const openNow = useOpenNow(details.data);
  ...
  const hoursEmptyLabel =
    destination.openingHoursAvailability === 'Unavailable'
          ...
          <section className={styles.section}>
            ...
            <div className={styles.infoBlock}>
              ...
              <InfoRow
                ...
                badge={<OpenNowBadge result={openNow} />}
                emptyLabel={hoursEmptyLabel}
              />
              <InfoRow
                label="Website"
