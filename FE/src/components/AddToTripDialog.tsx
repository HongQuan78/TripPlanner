...
import { formatDate, formatDateRange } from '../pages/dates';
  ...
  return (
    <div className={dialogStyles.overlay}>
      ...
      >
        ...
        {selectedTrip !== null && (
          <>
            <button type="button" className={styles.back} onClick={() => setSelectedTrip(null)}>
              ← Back to trips
            </button>
            <div className={styles.list}>
        ...
        <div className={dialogStyles.actions}>
          <button type="button" className={dialogStyles.cancel} onClick={onClose}>
            Cancel
          </button>
        </div>
      </div>
