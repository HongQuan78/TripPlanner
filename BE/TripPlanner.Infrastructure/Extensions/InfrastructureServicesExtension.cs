...
using TripPlanner.Infrastructure.ExternalServices.TimeZones;
...
public static class InfrastructureServicesExtension
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddOptions<OverpassSettings>()
            ...
            .Validate(settings => settings.CacheMinutes > 0, "OverpassSettings:CacheMinutes must be greater than zero.")
            .ValidateOnStart();
