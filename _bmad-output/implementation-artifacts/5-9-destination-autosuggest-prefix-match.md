...
- [Source: _bmad-output/implementation-artifacts/5-7-search-auto-suggest.md] — origin story; its Dev Notes explicitly flagged the single-best-match limitation ("the dropdown must look right with one item") which this story now resolves
- [Source: _bmad-output/implementation-artifacts/8-1-destination-image-wikipedia-fallback.md] — precedent for adding a free/keyless external service alongside OpenTripMap
