...
- [x] [Review][Patch] Completion note "nullable C# members as | null" is inaccurate for request DTOs — CreateTripRequest/UpdateTripRequest fields are deliberately stricter than the nullable C# records; correct the note [_bmad-output/implementation-artifacts/5-1-frontend-scaffold-and-api-client.md]
