...
- [Source: _bmad-output/implementation-artifacts/archive/5-4-destination-details.md] — `/attractions/:xid` route/page this story links into
- [Source: _bmad-output/implementation-artifacts/archive/5-5-trip-planner-ui.md] — prior review finding on the inverse nested-interactive-element bug in `AttractionCard.tsx`
