...
- [Source: _bmad-output/implementation-artifacts/archive/5-6-ui-modernization-cute-light-blue.md] — token-driven restyle pattern and behavior-freeze convention this story repeats.
- [Source: _bmad-output/implementation-artifacts/archive/5-10-ui-motion-and-depth-polish.md] — motion tokens/route-transition/blobs/card-hover this story keeps, removes, or adjusts.
