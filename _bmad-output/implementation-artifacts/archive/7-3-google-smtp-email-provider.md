...
- [Source: _bmad-output/implementation-artifacts/archive/7-2-email-provider-strategy-pattern.md] — prior story that created the content/transport seams this story extends
