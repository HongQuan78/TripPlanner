...
- [Source: _bmad-output/implementation-artifacts/archive/8-1-destination-image-wikipedia-fallback.md] — predecessor story; its Dev Notes explain the Wikipedia-over-stock-photo rationale and the graceful-degradation contract this story inherits
- [Source: _bmad-output/implementation-artifacts/archive/7-2-email-provider-strategy-pattern.md] — the repo's provider-swap convention (`IEmailSender`) this story's seam mirrors
