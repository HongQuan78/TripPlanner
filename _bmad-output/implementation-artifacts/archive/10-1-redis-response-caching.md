...
- [Source: _bmad-output/implementation-artifacts/archive/6-4-attraction-detail-caching.md] — the in-memory cache seam this story promotes to Redis, and its preserved contracts.
- [Source: _bmad-output/implementation-artifacts/archive/9-1-dockerize-for-production.md] — the compose stack (`db`/`api`/`web`) the `redis` service joins.
