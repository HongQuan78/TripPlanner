...
- [Source: _bmad-output/implementation-artifacts/7-2-email-provider-strategy-pattern.md] — prior story in this repo using the same "new Application interface + Infrastructure implementation + DI registration" shape this story follows
