...
- [Source: _bmad-output/implementation-artifacts/5-6-ui-modernization-cute-light-blue.md] — design token set, behavior-freeze convention, and card/button hover conventions this story builds on.
