...
- [Source: _bmad-output/implementation-artifacts/10-1-redis-response-caching.md] — the story that introduced the `redis` service, the conditional registration, and the hard-coded value this story replaces; also the owner of the six open review patches deliberately excluded here.
