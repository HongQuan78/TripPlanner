...
- [Source: _bmad-output/implementation-artifacts/10-2-redis-connection-string-in-env.md] — the pattern this story mirrors.
...
- `_bmad-output/implementation-artifacts/10-3-postgres-host-in-env.md` (new — this story)
