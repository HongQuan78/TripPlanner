...
- [Source: _bmad-output/implementation-artifacts/3-4-schedule-destinations-into-day.md (Saved Places pool, @dnd-kit setup, optimistic move + rollback, accessible fallback conventions)]
