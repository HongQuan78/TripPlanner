...
public class DestinationServiceTests
{
    ...
    private GetAllDestinationsUseCase AllUseCase() => new(_destinationRepository, _mapper);
    private GetDestinationByIdUseCase ByIdUseCase() => new(_destinationRepository, _mapper);
    ...
    public async Task GetAllDestinationsAsync_ReturnsSuccessResult()
    {
        ...
        var result = await AllUseCase().ExecuteAsync(filter);
    ...
    public async Task GetDestinationByIdAsync_ExistingId_ReturnsSuccessResult()
    {
        ...
        var result = await ByIdUseCase().ExecuteAsync(1);
    ...
    public async Task GetDestinationByIdAsync_NonExistingId_ReturnsNotFoundFailure()
    {
        ...
        var result = await ByIdUseCase().ExecuteAsync(99);
